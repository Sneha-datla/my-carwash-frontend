    ...
    <div>
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-12">
                                            <h1 className="text-white font-weight-bold mb-4 h2Large">Portfolio Grid</h1>
      ...
      <div className="container">
        ...
        {filteredServices.map((service: any) => (
          <div key={service.id} className={`col-12 col-md-6 col-lg-4 ${service.category}`}>
							<article className="gPhoColumn position-relative overflow-hidden mb-6">
              <img src={`http://localhost:1337${service.image.url}`} className="img-fluid w-100" alt={service.title} />
              <h5 className="h5 text-white">
                {service.title}
                <strong className="pgCategory text-uppercase d-block">{service.category}</strong>
              </h5>
              <a href="portfolioSingle1.html" className="d-inline-block pgLink">
      ...
      <div className="text-center">
        ...
        >
          ...
          {/* Other items similar to the previous ones */}
          {/* ... */}
