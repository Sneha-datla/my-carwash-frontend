    ...
    <div>
                        ...
                        <div className="container">
                          <div className="row">
                            <div className="col-12">
                              <h1 className="text-white font-weight-bold mb-4 h2Large">Blog Masonry</h1>
      ...
      >
        ...
        <Link href="/blogSinglePost" className="btnLink fwSemi">Read More
          ...
          <div className="col-12 col-sm-6 col-lg-4 isoCol">
        <article className="blockPostColumn blogClassicVII position-relative fontAlter mb-8 mb-md-11 mb-xl-14">
          <div className="fdbWrap bgCover rounded position-relative mb-6 px-3 px-xl-5" style={{ backgroundImage: "url(/images/bgPattern08.jpg)" }}>
            <blockquote className="feedbackSlide fontAlter position-relative mb-0">
              ...
              <cite className="d-block">
                <strong className="d-block font-weight-normal text-capitalize">-Paul Tournier</strong>
              </cite>
            </blockquote>
          </div>
          <div className="px-3">
      ...
      <div className="col-12 col-sm-6 col-lg-4 isoCol">
        <article className="blockPostColumn blogClassicVII position-relative fontAlter mb-8 mb-md-11 mb-xl-14">
          <div className="fdbWrap bgCover rounded position-relative mb-6 px-3 px-xl-5" style={{ backgroundImage: "url(/images/bgPattern08.jpg)" }}>
            <blockquote className="feedbackSlide fontAlter position-relative mb-0">
              <span className="icnWrap d-block mb-4">
                <span className="icomoon-link"></span>
              </span>
              <q className="d-block position-relative mb-n2">Cars is simply clean and Clear by my service</q>
            </blockquote>
          </div>
          <div className="px-3">
            <span className="catTag mb-5">General</span>
